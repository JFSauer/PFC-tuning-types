...
target_dir="/media/jonas/data3/HM_wm_data/playground/spatial_tuning_types_analysis/spatial_tuning_outward_inward/using_sign_transients/revision_analysis/trial_type_prediction/trial_type_prediction_as_a_function_of_cells"
...
res_total=res
os.chdir(target_dir)    
N.save("decoding_trail_outcome_with_specific_types_by_mouse_function_of_neurons",res)
